        ...
        if (other.gethealth() == 0){
            ...
            if (this.losemana(15)){
                if (this.isCrit()){
                    atk = atk * 2;
                    crit = true;
                } System.out.println(this.getName() + " unleashes a fireball at " + other.getName() + "!");
                if (other.dodge()){
        ...
        if (other.gethealth() == 0){
            ...
            if (this.losemana(20)){
                if (this.isCrit()){
                    atk = atk * 2;
                    crit = true;
                } System.out.println(this.getName() + " summons a fire under " + other.getName() + "!");
                if (other.dodge()){
                    System.out.println(other.getName() + " dodged the attack!");
                } else{
                    if (crit){
        ...
        if (other.gethealth() == 0){
            ...
            if (this.losemana(20)){
                if (this.isCrit()){
                    atk = atk * 2;
                    crit = true;
                } System.out.println(this.getName() + " summons a phoenix to attack " + other.getName() + "!");
                if (other.dodge()){
                    System.out.println(other.getName() + " dodged the attack!");
                } else{
                    if (crit){
